...
def get_job_data(job_dict):
    """
    Creates a dictionary with job id as key and rest of the job information as value.
    :input job_dict: contains information about every job
    """
    job_to_info = {}
    job_ids = []
    for job in job_dict:
...
def map_parent_children(dependency):
    """
    Creates a dictionary with key as Parent ID and value as Children IDs.
    :input dependency: contains information about parent and children jobs.
    """
